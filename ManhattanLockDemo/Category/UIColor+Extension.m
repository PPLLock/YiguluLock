...
{
    return [UIColor colorWithHexString:@"1C1F4A"];//oxF18A31//FF82AB
}

+(UIColor *)colorLightWhiteColor
{
    return [UIColor colorWithHexString:@"F9F9F9"];//oxF18A31//FF82AB
}


+ (UIColor *)colorPopulColor
{
    //#a42f5d //E63864
    return [UIColor colorWithHexString:@"a42f5d"];//B2365F,178, 54, 95
}

+ (UIColor *)colorGreenColor
{
    
    return [UIColor colorWithHexString:@"60C878"];//0 203 119
}

+ (UIColor *)colorBrownColor
{
    
    return [UIColor colorWithHexString:@"E89646"];//250 144 68
}

+ (UIColor *)colorRedColor
{
    
    return [UIColor colorWithHexString:@"E04B44"];//247 55 64
}

+ (UIColor *)colorPlaceholderColor
{
    
    return [UIColor colorWithHexString:@"828282"];//247 55 64
}
...
+(UIColor *)colorDarkGrayColor{
    ...
    return [UIColor colorWithRed:94/255.0 green:93/255.0 blue:94/255.0 alpha:1];
}
